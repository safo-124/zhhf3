...
import { HandHeart, Mail, ArrowRight, Sparkles, Shield } from "lucide-react";
...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    if (!email) return;
    setLoading(true);
    // TODO: integrate actual magic link auth
            ...
            {sent ? (
              ...
              >
                ...
                <p className="text-gray-600 text-sm mb-6">
                  ...
                  <strong className="text-emerald-700">{email}</strong>. Click
